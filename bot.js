...
bot.on('message', msg=>{
  if(msg.content.toLowerCase() === "!jotaro"){
      msg.reply("DIO!");
...
bot.on('message', msg=>{
  if(msg.content.toLowerCase() ==="!koichi"){
      msg.reply("no diginity");
  }
})

bot.on('message', msg=>{
  if(msg.content.toLowerCase() ==="!kira"){
...
bot.on('message', msg=>{
  if(msg.content.toLowerCase() ==="!goodbye"){
      msg.reply("GOOD BYE JOJO!");
  }
})

bot.on('message', msg=>{
  if(msg.content.toLowerCase() ==="!go"){
...
bot.on('message', msg=>{
  if(msg.content.toLowerCase() ==="!venice"){
...
bot.on('message', msg=>{
  ...
  if(msg.content.toLowerCase() ==="!uber"){
...
bot.on('message', msg=>{
  if(msg.content.toLowerCase() ==="!caio"){
...
bot.on('message', msg=>{
  if(msg.content.toLowerCase() ==="!dororo"){
